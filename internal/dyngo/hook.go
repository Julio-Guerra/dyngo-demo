...
import (
	...
	"demo/internal/dyngo/internal"
	"demo/internal/sqlib/sqerrors"
	"demo/internal/sqlib/sqgo"
	"demo/internal/sqlib/sqsafe"
...
func Find(symbol string) (*Hook, error) {
	if _sqreen_instrumentation_descriptor == nil || len(_sqreen_instrumentation_descriptor.HookTable) == 0 {
		return nil, sqerrors.New("the program is not instrumented - please refer to docs.sqreen.com/go/installation in order to instrument your program")
	}
